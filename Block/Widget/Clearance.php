...
namespace Xigen\Clearance\Block\Widget;

class Clearance extends \Magento\Catalog\Block\Product\NewProduct implements \Magento\Widget\Block\BlockInterface
{
    /**
    ...
    {
        return $this->_getClearanceProductsCollection();
    }
     ...
     * @return \Magento\Catalog\Model\ResourceModel\Product\Collection|Object|\Magento\Framework\Data\Collection
     */
    protected function _getClearanceProductsCollection()
    {
        ...
        $collection = $this->_addProductAttributesAndPrices($collection)
            ...
            ->addAttributeToFilter('clearance', ['eq' => 1])
        ...
        if ($this->showPager()) {
            if (!$this->_pager) {
                $this->_pager = $this->getLayout()->createBlock(
                    ...
                    'widget.clerance.product.list.pager'
                );
